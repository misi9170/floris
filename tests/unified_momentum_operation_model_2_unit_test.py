...
def test_submodel_attributes():
    ...
    assert hasattr(UnifiedMomentumModelTurbine_2, "power")
    assert hasattr(UnifiedMomentumModelTurbine_2, "thrust_coefficient")
    assert hasattr(UnifiedMomentumModelTurbine_2, "axial_induction")
...
def test_UnifiedMomentumModelTurbine():
    ...
    test_power = UnifiedMomentumModelTurbine_2.power(
    ...
    print(test_power, baseline_power) #assert np.allclose(baseline_power, test_power)
    ...
    print(test_power, baseline_power) #assert test_power < baseline_power
